...
-- -----------------------------------------------------
-- Table `thecatlong`.`categorias_productos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `thecatlong`.`categorias_productos` (
  `idcategoria` INT NOT NULL COMMENT '',
  `idproducto` INT NOT NULL COMMENT '',
  PRIMARY KEY (`idcategoria`, `idproducto`)  COMMENT '',
  INDEX `fk_categorias_has_productos_productos1_idx` (`idproducto` ASC)  COMMENT '',
  INDEX `fk_categorias_has_productos_categorias1_idx` (`idcategoria` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `thecatlong`.`subcategorias` (
  `idsubcategoria` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `nombre` VARCHAR(45) NULL COMMENT '',
...
-- -----------------------------------------------------
-- Table `thecatlong`.`categorias_subcategorias`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `thecatlong`.`categorias_subcategorias` (
  `idcategoria` INT NOT NULL COMMENT '',
  `idsubcategoria` INT NOT NULL COMMENT '',
...
-- -----------------------------------------------------
-- Table `thecatlong`.`compras_has_productos_tallas_colores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `thecatlong`.`compras_has_productos_tallas_colores` (
  `idcompra` INT NOT NULL COMMENT '',
  `username` VARCHAR(45) NOT NULL COMMENT '',
  `idproducto` INT NOT NULL COMMENT '',
  `idtalla` INT NOT NULL COMMENT '',
